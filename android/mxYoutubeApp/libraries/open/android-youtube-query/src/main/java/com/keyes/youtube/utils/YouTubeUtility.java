...
public class YouTubeUtility {
	 ...
	 */
	public static String queryLatestPlaylistVideo(PlaylistId pPlaylistId) throws IOException, ClientProtocolException,
		...
		HttpGet lGetMethod = new HttpGet(Youtube_URL.YOUTUBE_PLAYLIST_ATOM_FEED_URL + pPlaylistId.getId()
	...
	/**
	 * Calculate the YouTube URL to load the video. Includes retrieving a token that YouTube requires to play the video.
	 *
