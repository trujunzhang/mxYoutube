...
public class RendererBuilderFactory {
	 ...
	 * 
	 * @param ctx
	 *            The context (ex {@link android.app.Activity} in whicb the video has been created.
	 * @param video
	 *            The video which will be played.
	 */
	public static ExoplayerWrapper.RendererBuilder createRendererBuilder(Context ctx, Video video) {
		switch (video.getVideoType()) {
		case DASH_VOD:
			return new DashVodRendererBuilder(ExoplayerUtil.getUserAgent(ctx), video.getUrl(), video.getContentId(),
