...
/**
 * Extends the {@link com.google.android.exoplayer.util.PlayerControl} class, which is responsible for controlling
 * playback (ex play, pause, seek, get duration, get elapsed time) by adding the ability to make a list of callbacks
 * which respond when the player is paused or played.
 */
public class ObservablePlayerControl extends PlayerControl {
	...
	/**
	 * @param exoPlayer
	 *            The {@link com.google.android.exoplayer.ExoPlayer} instance to control.
	 */
	 ...
	 * 
	 * @param callback
	 *            Responds when the player is paused or played.
	 */
