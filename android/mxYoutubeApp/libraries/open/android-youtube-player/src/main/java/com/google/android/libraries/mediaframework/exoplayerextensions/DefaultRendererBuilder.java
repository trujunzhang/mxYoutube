...
/**
 * A {@link ExoplayerWrapper.RendererBuilder} for streams that can be read using {@link android.media.MediaExtractor}.
 */
public class DefaultRendererBuilder implements ExoplayerWrapper.RendererBuilder {
	...
	/**
	 * The context (ex {@link android.app.Activity}) in which this {@link ExoplayerWrapper.RendererBuilder} was created.
	 */
	...
	/**
	 * @param context
	 *            The context (ex {@link android.app.Activity}) in which this {@link ExoplayerWrapper.RendererBuilder}
	 *            was created.
	 * @param uri
	 *            The URL of the video that this {@link ExoplayerWrapper.RendererBuilder} will build.
	 */
	...
	public void buildRenderers(ExoplayerWrapper player, ExoplayerWrapper.RendererBuilderCallback callback) {
		...
		MediaCodecVideoTrackRenderer videoRenderer = new MediaCodecVideoTrackRenderer(sampleSource, null, true,
				MediaCodec.VIDEO_SCALING_MODE_SCALE_TO_FIT, ALLOWED_JOINING_TIME_MS, player.getMainHandler(), player,
