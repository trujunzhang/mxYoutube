...
public final class VideoFileDetails extends com.google.api.client.json.GenericJson {
  ...
  static {
    // hack to force ProGuard to consider VideoFileDetailsAudioStream used, since otherwise it would be stripped out
    // see http://code.google.com/p/google-api-java-client/issues/detail?id=528
    com.google.api.client.util.Data.nullOf(VideoFileDetailsAudioStream.class);
  }
   ...
   * Coordinates are defined using WGS 84.
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  ...
  static {
    // hack to force ProGuard to consider VideoFileDetailsVideoStream used, since otherwise it would be stripped out
    // see http://code.google.com/p/google-api-java-client/issues/detail?id=528
    com.google.api.client.util.Data.nullOf(VideoFileDetailsVideoStream.class);
  }
   ...
   * Geographic coordinates that identify the place where the uploaded video was recorded.
   * Coordinates are defined using WGS 84.
   * @param recordingLocation recordingLocation or {@code null} for none
   */
  public VideoFileDetails setRecordingLocation(GeoPoint recordingLocation) {
