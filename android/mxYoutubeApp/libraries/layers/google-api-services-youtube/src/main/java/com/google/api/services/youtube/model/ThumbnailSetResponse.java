...
public final class ThumbnailSetResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<ThumbnailDetails> items;
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<ThumbnailDetails> getItems() {
    return items;
  }
   ...
   */
  public ThumbnailSetResponse setItems(java.util.List<ThumbnailDetails> items) {
    this.items = items;
    return this;
  }
