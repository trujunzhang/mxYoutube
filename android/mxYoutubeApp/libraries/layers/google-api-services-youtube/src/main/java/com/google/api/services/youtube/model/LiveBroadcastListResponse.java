...
public final class LiveBroadcastListResponse extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<LiveBroadcast> items;
   ...
   */
  public LiveBroadcastListResponse setEtag(java.lang.String etag) {
    this.etag = etag;
    return this;
  }
   ...
   */
  public LiveBroadcastListResponse setEventId(java.lang.String eventId) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<LiveBroadcast> getItems() {
    return items;
  }
   ...
   */
  public LiveBroadcastListResponse setItems(java.util.List<LiveBroadcast> items) {
    this.items = items;
    return this;
  }
   ...
   */
  public LiveBroadcastListResponse setKind(java.lang.String kind) {
    this.kind = kind;
    return this;
  }
   ...
   */
  public LiveBroadcastListResponse setNextPageToken(java.lang.String nextPageToken) {
   ...
   */
  public LiveBroadcastListResponse setPrevPageToken(java.lang.String prevPageToken) {
   ...
   */
  public LiveBroadcastListResponse setVisitorId(java.lang.String visitorId) {
    this.visitorId = visitorId;
    return this;
  }

  @Override
  public LiveBroadcastListResponse set(String fieldName, Object value) {
    return (LiveBroadcastListResponse) super.set(fieldName, value);
  }
