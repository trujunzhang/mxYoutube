...
public interface ILoadingLayout {
	...
	/**
	 * Set's the Sets the typeface and style in which the text should be displayed. Please see
	 * {@link android.widget.TextView#setTypeface(Typeface) TextView#setTypeface(Typeface)}.
	 */
