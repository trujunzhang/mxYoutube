...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public static interface OnPullEventListener<V extends View> {
		 ...
		 * @param direction
		 *            - One of {@link Mode#PULL_FROM_START} or {@link Mode#PULL_FROM_END} depending on which direction
		 *            the user is pulling. Only useful when <var>state</var> is {@link State#PULL_TO_REFRESH} or
