...
public class FragmentLayoutSupport extends SherlockFragmentActivity {
	...
	/**
	 * This is the "top-level" fragment, showing a list of items that the user can pick. Upon picking an item, it takes
	 * care of displaying the data to the user as appropriate based on the currrent UI layout.
	 */
