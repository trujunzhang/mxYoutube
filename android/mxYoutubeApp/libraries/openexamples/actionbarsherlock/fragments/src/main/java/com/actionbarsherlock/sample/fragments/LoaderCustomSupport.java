...
public class LoaderCustomSupport extends SherlockFragmentActivity {
	...
	public static class AppListLoader extends AsyncTaskLoader<List<AppEntry>> {
		...
		/**
		 * This is where the bulk of our work is done. This function is called in a background thread and should
		 * generate a new set of data to be published by the loader.
		 */
		@Override
	...
	public static class AppListFragment extends SherlockListFragment implements
